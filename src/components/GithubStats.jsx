    ...
    <section id="github" className="section-wrap">
      ...
      >
        ...
        <p className="text-ink-500 text-sm font-mono">
          Swap <span className="text-blue-400">"{username}"</span> in GithubStats.jsx for your real username
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-8">
        ...
        >
          <img
            ...
            src={`https://github-readme-stats.vercel.app/api?username=${username}&show_icons=true&theme=transparent&hide_border=true&title_color=6E93FF&icon_color=9D5CFF&text_color=B7BFD6`}
            alt="GitHub stats"
          />
        </motion.div>
